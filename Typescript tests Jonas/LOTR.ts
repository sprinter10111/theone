...
async function main(){
    ...
    let antwoordCharacter : string = input.question("Antwoord: ");
    ...
    if(antwoordMovie.toLowerCase() === character.name.toLowerCase()){
        score++;
    }
    switch(score){
        case 0:
            console.log("Je had niets juist");
            break;
        case 1:
            console.log("Je had de helft juist");
            break;
        case 2:
            console.log("Je had alles juist");
            break;
    }
}
main();
